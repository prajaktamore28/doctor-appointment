...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                <img src="image/stethoscope.png" alt="" width = "50" height = "50">
                <a class="navbar-brand js-scroll-trigger" href="./">Your Doctor Guide</a>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                        ...
                        <div><a class="d-block" href="mailto:<?php echo $_SESSION['setting_email'] ?>"><?php echo "+913467890345" ?></a></div>
                    </div>
                    ...
                    <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                        ...
                        <div><a class="d-block" href="mailto:<?php echo $_SESSION['setting_email'] ?>"><?php echo "facebook.com" ?></a></div>
                    </div>
                    
                    <div class="col-lg-4 mr-auto text-center">
                        <i class="fab fa-instagram-square fa-3x mb-3 text-muted"></i>
                        <!-- Make sure to change the email address in BOTH the anchor text and the link target below!-->
                        <a class="d-block" href="mailto:<?php echo $_SESSION['setting_email'] ?>"><?php echo "instagram.com" ?></a>
                    </div>
                    <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                        <i class="fab fa-twitter-square fa-3x mb-3 text-muted"></i>
                        <div><a class="d-block" href="mailto:<?php echo $_SESSION['setting_email'] ?>"><?php echo "twitter.com" ?></a></div>
                    </div>
                    <div class="col-lg-4 mr-auto text-center">
                        <i class="fab fa-telegram fa-3x mb-3 text-muted"></i>
                        <!-- Make sure to change the email address in BOTH the anchor text and the link target below!-->
                        <a class="d-block" href="mailto:<?php echo $_SESSION['setting_email'] ?>"><?php echo "telegram.com" ?></a>
                    </div>
